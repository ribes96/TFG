...
%
% It is well suited for very inestable methods. This is, methods which produce
...
% answers, just as a comittee of experts needs to have different opinions to unleash
% all it power. If all of them say the same, there is no need for a comittee.
%
...
% reducing the ammount of computation needed to do the trick, but it is not
...
% algorithm): the unstability of this method makes it easier for each of the trees
...
% \section{Planification}
% The original planification of the project was to test the ideas explained in
...
% \section{Methodology}
% From the begining of the project I've been using the Waterfall Model, since there
% is a logical and simple order in which tasks must be done, and it is very
% flexible.
%
% Although the planification of the project has changed very much, the metholology
...
% TODO pensar qué disciplinas sería bueno que integrara
...
% \begin{itemize}
%     \item Simplicity
%     \item Can chose whatever text editor I'm confortable with
%     \item Very Scalable
% \end{itemize}
% Cons:
% \begin{itemize}
...
%     \item Writing interface is not confortable
%     \item Allows unordered programming, giving place to buggy code
%     \item Not scallable to large projects
% \end{itemize}
...
%     &
%     %% CONS, seperated by empty line or \par
%     Not standarized the way to vote\par
%     \\\bottomrule
%     \end{tabularx}
...
% The whole code of the project is Python. It uses a very permisive licence
% compatible with GPL (General Public Licence)
% \paragraph{Machine Learning Library Scikit-Learn}
% I use a lot of code of this library. It uses the 3-Clause BSD Licence, which is
% very permisive
% \paragraph{Jupyter Notebook}
% It is the interface I use  to run my code. It also uses the 3-Caluse BSD Licence.
