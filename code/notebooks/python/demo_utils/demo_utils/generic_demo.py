# from general import get_non_sampling_error_graph_from_scores
# from general import get_sampling_error_graph_from_scores
# from general import SUPPORTED_DATASETS
...
class Demo:
    ...
    def get_default_gamma_selector(self):
        gamma_selector = FloatLogSlider(value=-0.01, base=10, min=-4, max=2,
                                        step=1)
        return gamma_selector
    ...
    #     }
    #
    #     box = VBox([model_selector, sampler_selector, gamma_selector,
    #                 box_type_selector, n_estim_selector, dt_mid_selector,
    #                 logit_C_selector, linear_svc_C_selector])
    #
    #     return box, dic
