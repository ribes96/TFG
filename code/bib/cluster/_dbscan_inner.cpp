...
#define __PYX_HAVE__bib__cluster___dbscan_inner
#define __PYX_HAVE_API__bib__cluster___dbscan_inner
#include <vector>
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from 'bib.cluster._dbscan_inner' */
static CYTHON_INLINE void __pyx_f_3bib_7cluster_13_dbscan_inner_push(std::vector<npy_intp>  &, npy_intp); /*proto*/
...
#define __Pyx_MODULE_NAME "bib.cluster._dbscan_inner"
int __pyx_module_is_main_bib__cluster___dbscan_inner = 0;

/* Implementation of 'bib.cluster._dbscan_inner' */
...
static const char __pyx_k_bib_cluster__dbscan_inner[] = "bib.cluster._dbscan_inner";
static const char __pyx_k_cluster__dbscan_inner_pyx[] = "cluster/_dbscan_inner.pyx";
...
static PyObject *__pyx_n_s_bib_cluster__dbscan_inner;
static PyObject *__pyx_n_s_cline_in_traceback;
static PyObject *__pyx_kp_s_cluster__dbscan_inner_pyx;
...
static PyObject *__pyx_pf_3bib_7cluster_13_dbscan_inner_dbscan_inner(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_is_core, PyArrayObject *__pyx_v_neighborhoods, PyArrayObject *__pyx_v_labels); /* proto */
...
/* "bib/cluster/_dbscan_inner.pyx":13
...
static CYTHON_INLINE void __pyx_f_3bib_7cluster_13_dbscan_inner_push(std::vector<npy_intp>  &__pyx_v_stack, npy_intp __pyx_v_i) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("push", 0);

  /* "bib/cluster/_dbscan_inner.pyx":14
 * # a cdef function with an "except +" declaration.
 * cdef inline void push(vector[np.npy_intp] &stack, np.npy_intp i) except +:
 *     stack.push_back(i)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("bib.cluster._dbscan_inner.push", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "bib/cluster/_dbscan_inner.pyx":19
...
/* Python wrapper */
static PyObject *__pyx_pw_3bib_7cluster_13_dbscan_inner_1dbscan_inner(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_3bib_7cluster_13_dbscan_inner_1dbscan_inner = {"dbscan_inner", (PyCFunction)__pyx_pw_3bib_7cluster_13_dbscan_inner_1dbscan_inner, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_3bib_7cluster_13_dbscan_inner_1dbscan_inner(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("bib.cluster._dbscan_inner.dbscan_inner", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_3bib_7cluster_13_dbscan_inner_dbscan_inner(__pyx_self, __pyx_v_is_core, __pyx_v_neighborhoods, __pyx_v_labels);
...
static PyObject *__pyx_pf_3bib_7cluster_13_dbscan_inner_dbscan_inner(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_is_core, PyArrayObject *__pyx_v_neighborhoods, PyArrayObject *__pyx_v_labels) {
  npy_intp __pyx_v_i;
  ...
  /* "bib/cluster/_dbscan_inner.pyx":22
 *                  np.ndarray[object, ndim=1] neighborhoods,
 *                  np.ndarray[np.npy_intp, ndim=1, mode='c'] labels):
 ...
 */
  ...
  /* "bib/cluster/_dbscan_inner.pyx":26
 *     cdef vector[np.npy_intp] stack
 * 
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "bib/cluster/_dbscan_inner.pyx":27
 * 
 *     for i in range(labels.shape[0]):
 *         if labels[i] != -1 or not is_core[i]:             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "bib/cluster/_dbscan_inner.pyx":28
 *     for i in range(labels.shape[0]):
 *         if labels[i] != -1 or not is_core[i]:
 *             continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "bib/cluster/_dbscan_inner.pyx":34
 ...
 */
    while (1) {
      ...
      /* "bib/cluster/_dbscan_inner.pyx":35
 *         # part of a cluster (component), but don't expand their neighborhoods.
 *         while True:
 *             if labels[i] == -1:             # <<<<<<<<<<<<<<
 *                 labels[i] = label_num
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "bib/cluster/_dbscan_inner.pyx":36
 *         while True:
 *             if labels[i] == -1:
 *                 labels[i] = label_num             # <<<<<<<<<<<<<<
 *                 if is_core[i]:
 ...
 */
        ...
        *__Pyx_BufPtrCContig1d(npy_intp *, __pyx_pybuffernd_labels.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_labels.diminfo[0].strides) = __pyx_v_label_num;
        ...
        /* "bib/cluster/_dbscan_inner.pyx":37
 *             if labels[i] == -1:
 *                 labels[i] = label_num
 *                 if is_core[i]:             # <<<<<<<<<<<<<<
 *                     neighb = neighborhoods[i]
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "bib/cluster/_dbscan_inner.pyx":38
 *                 labels[i] = label_num
 *                 if is_core[i]:
 *                     neighb = neighborhoods[i]             # <<<<<<<<<<<<<<
 *                     for i in range(neighb.shape[0]):
 ...
 */
          ...
          /* "bib/cluster/_dbscan_inner.pyx":39
 *                 if is_core[i]:
 *                     neighb = neighborhoods[i]
 *                     for i in range(neighb.shape[0]):             # <<<<<<<<<<<<<<
 *                         v = neighb[i]
 ...
 */
          ...
          for (__pyx_t_18 = 0; __pyx_t_18 < __pyx_t_17; __pyx_t_18+=1) {
            ...
            /* "bib/cluster/_dbscan_inner.pyx":40
 *                     neighb = neighborhoods[i]
 *                     for i in range(neighb.shape[0]):
 *                         v = neighb[i]             # <<<<<<<<<<<<<<
 *                         if labels[v] == -1:
 ...
 */
            ...
            /* "bib/cluster/_dbscan_inner.pyx":41
 *                     for i in range(neighb.shape[0]):
 *                         v = neighb[i]
 *                         if labels[v] == -1:             # <<<<<<<<<<<<<<
 *                             push(stack, v)
 ...
 */
            ...
            if (__pyx_t_3) {
              ...
              /* "bib/cluster/_dbscan_inner.pyx":42
 *                         v = neighb[i]
 *                         if labels[v] == -1:
 *                             push(stack, v)             # <<<<<<<<<<<<<<
 * 
 ...
 */
              try {
                __pyx_f_3bib_7cluster_13_dbscan_inner_push(__pyx_v_stack, __pyx_v_v);
              } catch(...) {
                __Pyx_CppExn2PyErr();
 ...
 */
      ...
      /* "bib/cluster/_dbscan_inner.pyx":44
 *                             push(stack, v)
 * 
 *             if stack.size() == 0:             # <<<<<<<<<<<<<<
 *                 break
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "bib/cluster/_dbscan_inner.pyx":45
 * 
 *             if stack.size() == 0:
 *                 break             # <<<<<<<<<<<<<<
 *             i = stack.back()
 ...
 */
      ...
      /* "bib/cluster/_dbscan_inner.pyx":46
 *             if stack.size() == 0:
 *                 break
 *             i = stack.back()             # <<<<<<<<<<<<<<
 *             stack.pop_back()
 ...
 */
      ...
      /* "bib/cluster/_dbscan_inner.pyx":47
 *                 break
 *             i = stack.back()
 *             stack.pop_back()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "bib/cluster/_dbscan_inner.pyx":49
 *             stack.pop_back()
 * 
 *         label_num += 1             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_bib_cluster__dbscan_inner, __pyx_k_bib_cluster__dbscan_inner, sizeof(__pyx_k_bib_cluster__dbscan_inner), 0, 0, 1, 1},
  {&__pyx_n_s_cline_in_traceback, __pyx_k_cline_in_traceback, sizeof(__pyx_k_cline_in_traceback), 0, 0, 1, 1},
  {&__pyx_kp_s_cluster__dbscan_inner_pyx, __pyx_k_cluster__dbscan_inner_pyx, sizeof(__pyx_k_cluster__dbscan_inner_pyx), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(3, 0, 8, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cluster__dbscan_inner_pyx, __pyx_n_s_dbscan_inner, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_bib__cluster___dbscan_inner) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "bib.cluster._dbscan_inner")) {
      if (unlikely(PyDict_SetItemString(modules, "bib.cluster._dbscan_inner", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "bib/cluster/_dbscan_inner.pyx":8
 ...
 *                  np.ndarray[np.npy_intp, ndim=1, mode='c'] labels):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3bib_7cluster_13_dbscan_inner_1dbscan_inner, NULL, __pyx_n_s_bib_cluster__dbscan_inner); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_dbscan_inner, __pyx_t_1) < 0) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "bib/cluster/_dbscan_inner.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init bib.cluster._dbscan_inner", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init bib.cluster._dbscan_inner");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
