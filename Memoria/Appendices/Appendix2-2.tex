...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.5\linewidth}
    ...
    % \caption{Exp 2.2 with Random Fourier Feautures with Fashion MNIST. Error is decreased by 25\% approx.}
    \label{fig:\undPrefix_vowel}
  \end{subfigure}%
  \renewcommand{\filePrefix}{\undPrefix/nys}%
  \begin{subfigure}[t]{0.5\linewidth}
    \centering\captionsetup{width=.8\linewidth}\includegraphics[width=\imgscale\linewidth]{Figures/\filePrefix/fashion_mnist}
    % \caption{Exp 2.2 with \Nys\ with Fashion MNIST. Error is decreased by 25\% approx.}
    \label{fig:\undPrefix_vowel}
  \end{subfigure}
  \caption*{Exp 2.2 with Random Fourier Feautures (left) and \Nys\ (right)
  with Fashion MNIST. Error is decreased by 25\% approx.}
\end{figure}
