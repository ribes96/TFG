...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.5\linewidth}
    ...
    \label{fig:\undPrefix_pen_digits}
  \end{subfigure}%
  \caption*{Exp. 4.2 with Pen Digits. Random Forest and Ensembles of Decision Tree with RFF (left) and \Nys\ (right) have the same accuracy.}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.5\linewidth}
    ...
    \label{fig:\undPrefix_satellite}
  \end{subfigure}
  \caption*{Exp. 4.2 with Satellite. Random Forest and Ensembles of Decision Tree with RFF (left) and \Nys\ (right) have the same accuracy.}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.5\linewidth}
    ...
    \label{fig:\undPrefix_vowel}
  \end{subfigure}
  \caption*{Exp. 4.2 with Vowel. Ensembles of Decision Tree with RFF (left) and \Nys\ (right)
