...
\begin{pre-delivery}
	...
	augmenta significativament amb la grandària del conjunt de dades. En
	...
	d'estimadors fent servir Random Fourier Features i \Nys.
\end{pre-delivery}
...
\include{Chapters/Ch3_develop}
\include{Chapters/Ch4_expRes}
\include{Chapters/Ch5_conclusion}
\include{Chapters/Ch6_sustainability}
...
\include{Appendices/Appendix1-1}
\include{Appendices/Appendix2-1}
\include{Appendices/Appendix2-2}
\include{Appendices/Appendix2-3}
\include{Appendices/Appendix2-4}

\include{Appendices/Appendix3-1}
\include{Appendices/Appendix3-2}
\include{Appendices/Appendix3-3}
\include{Appendices/Appendix3-4}

\include{Appendices/Appendix4-1}
\include{Appendices/Appendix4-2}

% \include{Appendices/Appendix2-5}
% \include{Appendices/Appendix2-6}
%
% \include{Appendices/Appendix2-7}
% \include{Appendices/Appendix2-8}
